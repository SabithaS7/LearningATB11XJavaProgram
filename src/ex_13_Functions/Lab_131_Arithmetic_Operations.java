...
public class Lab_131_Arithmetic_Operations {
    ...
    static int div(int a, int b) { //throws ArithmeticException
        ...
        System.out.println("Division by zero is not allowed"); //("Division by zero is not allowed."); throw new ArithmeticException
        System.exit(0);
        }
